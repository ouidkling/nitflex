	...
	async create(user) {
		...
		try {
			...
			await MailerService.sendMail({
				to: `${newUser.name.toUpperCase()} ${newUser.firstName} <${newUser.email}>`,
				subject: 'Welcome to our platform',
				text: `Hello ${newUser.username}, thank you for joining us !`,
				html: `<p>Hello <b>${newUser.username}</b>, thank you for joining us !</p>`,
			});
